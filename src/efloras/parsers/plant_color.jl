...
rename = Dict(
    "blackish"      => "black",         "blueish"       => "blue",
    "brownish"      => "brown",         "cream"         => "white",
    "cream-yellow"  => "yellow",        "creamy"        => "cream",
    "crimson"       => "red",           "glaucous-pink" => "pink",
    "golden-yellow" => "yellow",        "greyish"       => "gray",
    "greenish"      => "green",         "ivory"         => "white",
    "lavendar"      => "purple",        "lavender"      => "purple",
    "lemon"         => "yellow",        "lilac"         => "purple",
    "maroon"        => "red-brown",     "olive-green"   => "green",
    "pink-violet"   => "pink-purple",   "pinkish"       => "pink",
    "purpleish"     => "purple",        "purplish"      => "purple",
    "reddish"       => "red",           "rose"          => "pink",
    "rose-coloured" => "pink",          "salmon-pink"   => "orange-pink",
    "scarlet"       => "red",           "silvery"       => "silver",
    "stramineous"   => "yellow",        "straw-colored" => "yellow",
    "sulphur-yellow" => "yellow",       "violet"        => "purple",
    "violetish"     => "purple",        "whitish"       => "white",
    "yellowish"     => "yellow",
)
